...
pids_to_kill="${!} ${pids_to_kill}"
{ /opt/pashlib recv*2b453b68-638a-4942-835d-76a475098317*1*0*/tmp/pash_8Z86Ixy/6e9e138c3e834eb78417be4b5ac285a0/#fifo16 send*4f58493e-a60f-4621-a82a-d6f4f449b722*0*1*/tmp/pash_8Z86Ixy/6e9e138c3e834eb78417be4b5ac285a0/#fifo25 & }
pids_to_kill="${!} ${pids_to_kill}"
