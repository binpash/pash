                ...
                if in_edge.has_file_resource():
                    ...
                    if in_edge == ec2_in_edge:  # TODO how to get bucket??
                        ...
                        remote_read = serverless_remote_pipe.make_serverless_remote_pipe(local_fifo_id=ephemeral_edge.get_ident(),
                                                                                ...
                                                                                output_edge=None,
                                                                                is_tcp=False)
                        # If using unlimited_lambda or no_hybrid, we add eager with is_s3=True, otherwise this node will run on ec2
                        pash_compiler.add_eager(ephemeral_edge.get_ident(), subgraph, file_id_gen, is_s3=(args.unlimited_lambda or args.no_hybrid))
