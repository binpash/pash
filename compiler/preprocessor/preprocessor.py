...
from parse import parse_shell_to_asts, from_ast_objects_to_shell, AstObject
from util import *
import server_util
...
def preprocess(input_script_path, args) -> str:
...
def preprocess_asts(
    ...
    if trans_options is transformation_options.SpeculativeTransformationState:
        ...
        assert unix_socket_file is not None
        msg = util_spec.scheduler_server_init_po_msg(trans_options.partial_order_file)
