...
def make_echo_ast(argument, var_file_path):
    ...
    if not var_file_path is None:
        arguments = [
            make_echo_string_to_argument("source"),
            make_echo_string_to_argument(var_file_path),
        ]
    ...
    arguments = [
        make_echo_string_to_argument("set"),
        make_echo_string_to_argument("--"),
        [variable_arg],
    ]
    ...
    arguments = [
        make_echo_string_to_argument("echo"),
        make_echo_string_to_argument("-n"),
        argument,
    ]
