...
class PreprocessedAST:
    def __init__(
        ...
        self.ast = ast
        self._replace_whole = replace_whole
        self._non_maximal = non_maximal
        self._something_replaced = something_replaced
        self._last_ast = last_ast

    @property
    def replace_whole(self):
        return self._replace_whole

    @property
    def non_maximal(self):
        return self._non_maximal

    @property
    def something_replaced(self):
        return self._something_replaced
