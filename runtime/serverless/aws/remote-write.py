...
s3.put_object(Bucket="yizhengx", Key=object_key, Body=object_data)
...
#             QueueUrl="https://sqs.us-east-1.amazonaws.com/192165654483/queue ", MessageBody=json.dumps(message_body)
#         )
