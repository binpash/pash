...
mkfifo_pash_fifos
pids_to_kill=""
{ sort -m "/tmp/pash_mExGzpm/df22ddb96643420cb1ebf41ebb6053fb/#fifo18" "/tmp/pash_mExGzpm/df22ddb96643420cb1ebf41ebb6053fb/#fifo19" >"/tmp/pash_mExGzpm/5e70c60be6cb4f048462289dd017d2ad/#fifo12" & }
pids_to_kill="${!} ${pids_to_kill}"
{ runtime/pashlib-ft recv*12329258-0e5c-4b3f-a37e-613d187b9961*1*0*/tmp/pash_mExGzpm/5e70c60be6cb4f048462289dd017d2ad/#fifo11 recv*53880cce-bf65-4a27-b383-c4ad58304e7c*1*0*/tmp/pash_mExGzpm/5e70c60be6cb4f048462289dd017d2ad/#fifo17 & }
pids_to_kill="${!} ${pids_to_kill}"
