...
mkfifo_pash_fifos
pids_to_kill=""
{ cat "/tmp/pash_mExGzpm/df22ddb96643420cb1ebf41ebb6053fb/#fifo19" >"/tmp/pash_mExGzpm/5e70c60be6cb4f048462289dd017d2ad/#fifo12" & }
pids_to_kill="${!} ${pids_to_kill}"
{ runtime/pashlib-ft recv*53880cce-bf65-4a27-b383-c4ad58304e7c*1*0*/tmp/pash_mExGzpm/5e70c60be6cb4f048462289dd017d2ad/#fifo17 & }
pids_to_kill="${!} ${pids_to_kill}"
pids_to_kill="${!} ${pids_to_kill}"
...
pids_to_kill="${!} ${pids_to_kill}"
{ python3 aws/s3-put-object.py "resumability/resumability-sorted.txt" "/tmp/pash_mExGzpm/5e70c60be6cb4f048462289dd017d2ad/#fifo12" $1 & }
pids_to_kill="${!} ${pids_to_kill}"
