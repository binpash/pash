cat $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN $IN                     |  # other tricks
