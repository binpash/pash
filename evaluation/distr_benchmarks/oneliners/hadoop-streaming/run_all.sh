...
# set-diff
hadoop jar $jarpath -files shortest-scripts_map.sh,shortest-scripts_reduce.sh -input $basepath/1G.txt -output $outputs_dir/shortest-scripts -mapper shortest-scripts_map.sh -reducer shortest-scripts_reduce.sh # shortest-scripts
