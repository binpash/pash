...
rm -f "#file17"
mkfifo "#file17"
cat "${IN_DIR}/p3.out_10_00" > "#file17" &
cat "${IN_DIR}/p3.out_10_01" > "#file18" &
cat "${IN_DIR}/p3.out_10_02" > "#file19" &
cat "${IN_DIR}/p3.out_10_03" > "#file20" &
cat "${IN_DIR}/p3.out_10_04" > "#file21" &
cat "${IN_DIR}/p3.out_10_05" > "#file22" &
cat "${IN_DIR}/p3.out_10_06" > "#file23" &
cat "${IN_DIR}/p3.out_10_07" > "#file24" &
cat "${IN_DIR}/p3.out_10_08" > "#file25" &
cat "${IN_DIR}/p3.out_10_09" > "#file26" &
