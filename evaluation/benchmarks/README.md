...
Quick Jump: [one-liners](#common-unix-one-liners) | [unixfun](#unix-50-from-bell-labs) | [weather analysis](#noaa-weather-analysis) | [web indexing](#wikipedia-web-indexing)
...
All of the Unix50 pipelines are in [evaluation/unixfun/unixfun.sh](../evaluation/unixfun/unixfun.sh).
The inputs of the pipelines are in [evaluation/unixfun/](../evaluation/unixfun/).
...
The plots are in:
- for `-s`: [evaluation/plots/unixfun_1GB_individual_speedups_4.pdf](../evaluation/plots/unixfun_1GB_individual_speedups_4.pdf)
- for `-l`: [evaluation/plots/unixfun_10GB_individual_speedups_16.pdf](../evaluation/plots/unixfun_10GB_individual_speedups_16.pdf)

Note that the pipelines in the plot are sorted with respect to speedup, and not by their ID.
So the first pipeline does not necessarily correspond to the first pipeline in [evaluation/unixfun](../evaluation/unixfun).
...
- [evaluation/results/weather-complete-2000-2000-seq.time](../evaluation/results/weather-complete-2000-2000-seq.time)
- [evaluation/results/weather-complete-2000-2000-16-pash.time](../evaluation/results/weather-complete-2000-2000-16-pash.time)
...
The results are saved in:
- [evaluation/results/weather-complete-2000-2004-seq.time](../evaluation/results/weather-complete-2000-2004-seq.time)
- [evaluation/results/weather-complete-2000-2004-16-pash.time](../evaluation/results/weather-complete-2000-2004-16-pash.time)
...
- [evaluation/results/weather-preprocess-2000-2000-seq.time](../evaluation/results/weather-preprocess-2000-2000-seq.time)
- [evaluation/results/weather-preprocess-2000-2000-16-pash.time](../evaluation/results/weather-preprocess-2000-2000-16-pash.time)
- [evaluation/results/weather-process-2000-2000-seq.time](../evaluation/results/weather-process-2000-2000-seq.time)
- [evaluation/results/weather-process-2000-2000-16-pash.time](../evaluation/results/weather-process-2000-2000-16-pash.time)
...
The program that we run, described in Section 6.4, can be seen in [evaluation/scripts/web-search.sh](../evaluation/scripts/web-search.sh).
...
The results are saved in:
- [evaluation/results/web-search-1000-seq.time](../evaluation/results/web-search-1000-seq.time)
- [evaluation/results/web-search-1000-2-pash.time](../evaluation/results/web-search-1000-2-pash.time)
- [evaluation/results/web-search-1000-16-pash.time](../evaluation/results/web-search-1000-16-pash.time)
...
- [evaluation/results/web-search-100000-seq.time](../evaluation/results/web-search-100000-seq.time)
- [evaluation/results/web-search-100000-2-pash.time](../evaluation/results/web-search-100000-2-pash.time)
- [evaluation/results/web-search-100000-16-pash.time](../evaluation/results/web-search-100000-16-pash.time)
