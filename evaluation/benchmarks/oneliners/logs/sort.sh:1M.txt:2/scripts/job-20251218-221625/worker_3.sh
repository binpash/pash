...
# Worker 3 for job job-20251218-221625
...
python3.9 aws/s3-put-object.py "jobs/job-20251218-221625/split_3.txt" "$FIFO" &
S3_PID=$!
...
echo "[Worker 3] Complete: jobs/job-20251218-221625/split_3.txt"
