...
# Worker 0 for job job-20251218-221504
...
python3.9 aws/s3-put-object.py "jobs/job-20251218-221504/split_0.txt" "$FIFO" &
S3_PID=$!
...
echo "[Worker 0] Complete: jobs/job-20251218-221504/split_0.txt"
