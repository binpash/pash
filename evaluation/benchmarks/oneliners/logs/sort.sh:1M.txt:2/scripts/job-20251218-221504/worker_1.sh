...
# Worker 1 for job job-20251218-221504
...
python3.9 aws/s3-put-object.py "jobs/job-20251218-221504/split_1.txt" "$FIFO" &
S3_PID=$!
...
echo "[Worker 1] Complete: jobs/job-20251218-221504/split_1.txt"
