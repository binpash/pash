...
for SCRIPT_INPUT in "${SCRIPT_INPUT_WIDTH[@]}"; do
    ...
    echo "------------------------------------------------------------------------"
    time IN="covid-mts/inputs/$INPUT" OUT="covid-mts/outputs/$SCRIPT:$INPUT:$WIDTH:noopt" \
    ...
    noopt_s3_key="covid-mts/outputs/$SCRIPT:$INPUT:$WIDTH:nooptstdout.txt"
    ...
    echo "Running $SCRIPT with input $INPUT and width $WIDTH"
    echo "------------------------------------------------------------------------"
    time IN="covid-mts/inputs/$INPUT" OUT="covid-mts/outputs/$SCRIPT:$INPUT:$WIDTH:s3opt" \
    ...
    s3opt_s3_key="covid-mts/outputs/$SCRIPT:$INPUT:$WIDTH:s3optstdout.txt"
...
echo "========================================================================"
echo "Results:"
echo "  - Baseline (no opt): covid-mts/outputs/*:noopt and logs/*:noopt"
echo "  - Optimized:         covid-mts/outputs/*:s3opt and logs/*:s3opt"
