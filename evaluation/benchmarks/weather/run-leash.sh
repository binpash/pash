...
time IN="weather/inputs/$INPUT" OUT="weather/outputs/$SCRIPT:$INPUT:$WIDTH:hybrid:" $PASH_TOP/pa.sh --serverless_exec -w"$WIDTH" --parallel_pipelines --parallel_pipelines_limit 16 scripts/"$SCRIPT" 
