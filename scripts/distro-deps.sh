...
case "$distro" in
   ubuntu*)  
     ...
     sudo apt-get install -y git libtool m4 curl automake pkg-config libffi-dev python python3 python3-pip wamerican-insane bc bsdmainutils g++-10 &> $LOG_DIR/apt_install.log
     ;;
   debian*)
     ...
     echo "|-- running apt install..."
     apt-get install -y git libtool curl sudo procps m4 automake pkg-config libffi-dev python python3 python3-pip wamerican-insane bc bsdmainutils g++-10 &> $LOG_DIR/apt_install.log
     ;;
   fedora*) 
