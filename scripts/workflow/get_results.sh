# Get repository root
REPO_ROOT=${REPO_ROOT:-$(git rev-parse --show-toplevel --show-superproject-working-tree)}
...
#
## intro tests
stats "$REPO_ROOT/evaluation/intro/output" intro
#
## Interface Tests
stats "$REPO_ROOT/evaluation/tests/interface_tests/output" interface
#
## compiler Tests
stats "$REPO_ROOT/evaluation/tests/results" compiler
