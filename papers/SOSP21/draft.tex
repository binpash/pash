...
\str
% \kk{Fast-path for us is not that simple as with other frameworks where they can release side-effects at will. Therefore we should make sure to solve it correctly and then have it in a section in the paper.}
